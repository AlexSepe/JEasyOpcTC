...
begin
  try
    ...
    on E:Exception do
      throwException(PEnv, SCoInitializeException, UTF8String(E.Message));
  end;
end;
...
begin
  try
    ...
    on E:Exception do
      throwException(PEnv, SCoUninitializeException, UTF8String(E.Message));
  end;
end;
...
begin
  try
    ...
    on E:ConnectivityException do
      throwException(PEnv, SConnectivityException, UTF8String(E.Message));
  end;
end;
  ...
  try
    try
      ...
      for I:=0 to count-1 do
        JVM.setObjectArrayElement(JOArray, I, JVM.StringToJString(Lists[I]));
      ...
      on E:HostException do
        throwException(PEnv, SHostException, UTF8String(E.Message));
      on E:NotFoundServersException do
        throwException(PEnv, SNotFoundServersException, UTF8String(E.Message));
    end;
  finally
    JVM.free;
    Browser.free;
  ...
  try
    try
      ...
      on E:UnableBrowseBranchException do
        throwException(PEnv, SUnableBrowseBranchException, UTF8String(E.Message));
      on E:UnableIBrowseException do
        throwException(PEnv, SUnableIBrowseException, UTF8String(E.Message));
    end;
  finally
    JVM.Free;
  end;
  ...
  try
    try
      ...
      on E:UnableBrowseLeafException do
        throwException(PEnv, SUnableBrowseLeafException, UTF8String(E.Message));
      on E:UnableIBrowseException do
        throwException(PEnv, SUnableIBrowseException, UTF8String(E.Message));
      on E:UnableAddGroupException do
        throwException(PEnv, SUnableAddGroupException, UTF8String(E.Message));
      on E:UnableAddItemException do
        throwException(PEnv, SUnableAddItemException, UTF8String(E.Message));
    end;
  finally
    JVM.Free;
  end;
...
begin
  try
    ...
    on E:SynchWriteException do
      throwException(PEnv, SSynchWriteException, UTF8String(E.Message));
    on E:VariantInternalException do
      throwException(PEnv, SVariantInternalException, UTF8String(E.Message));
  end;
end;
...
begin
  ...
  try
    ...
    on E:UnableRemoveGroupException do
      throwException(PEnv, SUnableRemoveGroupException, UTF8String(E.Message));
  end;
end;
...
begin
  ...
  try
    ...
    on E:UnableRemoveItemException do
      throwException(PEnv, SUnableRemoveItemException, UTF8String(E.Message));
  end;
end;
...
begin
  ...
  try
    ...
    on E:Asynch10ReadException do
      throwException(PEnv, SAsynch10ReadException, UTF8String(E.Message));
  end;
end;
...
begin
  ...
  try
    ...
    on E:Asynch20ReadException do
      throwException(PEnv, SAsynch20ReadException, UTF8String(E.Message));
  end;
end;
...
begin
  ...
  try
    ...
    on E:Asynch10UnadviseException do
      throwException(PEnv, SAsynch10UnadviseException, UTF8String(E.Message));
  end;
end;
...
begin
  ...
  try
    ...
    on E:Asynch20UnadviseException do
      throwException(PEnv, SAsynch20UnadviseException, UTF8String(E.Message));
  end;
end;
...
begin
  ...
  try
    ...
    on E:GroupUpdateTimeException do
      throwException(PEnv, SGroupUpdateTimeException, UTF8String(E.Message));
    on E:VariantInternalException do
      throwException(PEnv, SVariantInternalException, UTF8String(E.Message));
  end;
end;
...
begin
  ...
  try
    ...
    on E:GroupActivityException do
      throwException(PEnv, SGroupActivityException, UTF8String(E.Message));
    on E:VariantInternalException do
      throwException(PEnv, SVariantInternalException, UTF8String(E.Message));
  end;
end;
...
begin
  ...
  try
    ...
    on E:ItemActivityException do
      throwException(PEnv, SItemActivityException, UTF8String(E.Message));
    on E:VariantInternalException do
      throwException(PEnv, SVariantInternalException, UTF8String(E.Message));
  end;
end;
