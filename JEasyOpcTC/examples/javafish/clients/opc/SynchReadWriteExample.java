 ...
 * @throws SynchReadException 
   */
  public static void main(String[] args) throws InterruptedException, SynchReadException {
    ...
    try {
      ...
      for (int i = 0; i < 10; i++) {
        ...
        System.out.println(itemRead.getValue() + " -> " + itemRead);
      }
      
      // synchronous writing (example with array writing ;-)
      // prepare array
      VariantList list = new VariantList(Variant.VT_R8);
      list.add(new Variant(10.0));
      list.add(new Variant(20.0));
      list.add(new Variant(30.0));
