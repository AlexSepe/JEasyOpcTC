...
abstract public class JCustomOpc {
  ...
  static {
    ...
    //System.loadLibrary(props.getProperty("library.path"));
	  ...
	  try {
		NativeLoader.loadLibrary("/native/JCustomOpc.dll", "JCustomOpc");
	  } catch (IOException e) {
  ...
  synchronized static public void coUninitialize() throws CoUninitializeException {
    try {
      ...
      throw e;//new CoUninitializeException(Translate.getString("COUNINITIALIZE_EXCECPTION"));
    }
  }
  ...
  synchronized static public void coInitialize() throws CoInitializeException {
    try {
      ...
      throw e;//new CoInitializeException(Translate.getString("COINITIALIZE_EXCECPTION"));
    }
  }
  ...
  synchronized public void connect() throws ConnectivityException {
    try {
      ...
      throw e;//new ConnectivityException(Translate.getString("CONNECTIVITY_EXCEPTION") + " " + getHost() + "->" + getServerProgID());
    }
  }
