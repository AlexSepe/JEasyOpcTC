...
public class JOpcBrowser extends JCustomOpc {
  ...
  public static String[] getOpcServers(String host) throws HostException, NotFoundServersException {
    try {
      ...
      throw e;//new HostException(Translate.getString("HOST_EXCEPTION") + " " + host);
    }
    catch (NotFoundServersException e) {
      throw e;//new NotFoundServersException(Translate.getString("NOT_FOUND_SERVERS_EXCEPTION") + " " + host);
    }
  }
  ...
  public String[] getOpcBranch(String branch) throws UnableBrowseBranchException, UnableIBrowseException {
    try {
      ...
      throw e;//new UnableBrowseBranchException(Translate.getString("UNABLE_BROWSE_BRANCH_EXCEPTION"));
    }
    catch (UnableIBrowseException e) {
      throw e;//new UnableIBrowseException(Translate.getString("UNABLE_IBROWSE_EXCEPTION"));
    }
  }
  ...
  public String[] getOpcItems(String leaf, boolean download) throws UnableBrowseLeafException,
    ...
    try {
      ...
      throw e;//new UnableBrowseLeafException(Translate.getString("UNABLE_BROWSE_LEAF_EXCEPTION"));
    }
    catch (UnableIBrowseException e) {
      throw e;//new UnableIBrowseException(Translate.getString("UNABLE_IBROWSE_EXCEPTION"));
    }
    catch (UnableAddGroupException e) {
      throw e;//new UnableAddGroupException(Translate.getString("UNABLE_ADD_GROUP_EXCEPTION") + " " +host + "->" + serverProgID);
    }
    catch (UnableAddItemException e) {
      throw e;//new UnableAddItemException(Translate.getString("UNABLE_ADD_ITEM_EXCEPTION") + " " + host + "->" + serverProgID);
    }
  }
