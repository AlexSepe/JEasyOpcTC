...
public class JEasyOpc extends JOpc {
  ...
  synchronized public void run() {
    ...
    while (running) {
      try {
        ...
        while (running) { 
          ...
          if (!connected) {
            throw new ConnectivityException(("CONNECTIVITY_EXCEPTION") + " " +
    ...
    connected = false;
    running = false;
    log.info(("JEASYOPC_DISCONNECTED"));
  }
