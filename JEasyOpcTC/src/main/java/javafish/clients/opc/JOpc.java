...
public class JOpc extends JCustomOpc implements Runnable {
  ...
  public void addGroup(OpcGroup group) {
    ...
    if (!groups.containsKey(new Integer(group.getClientHandle()))) {
      ...
      throw new GroupExistsException(("GROUP_EXISTS_EXCEPTION") + " " +
          group.getGroupName());
    }
  }
  ...
  public void removeGroup(OpcGroup group) {
    if (groups.containsKey(new Integer(group.getClientHandle()))) {
      ...
      throw new GroupExistsException(("GROUP_NO_EXISTS_EXCEPTION") + " " +
          group.getGroupName());
    }
  }
  ...
  public void registerGroup(OpcGroup group)  
    ...
    try {
      ...
      throw e; //new ComponentNotFoundException(Translate.getString("COMPONENT_NOT_FOUND_EXCEPTION") + " " + group.getGroupName());
    }
    catch (UnableAddGroupException e) {
      throw e; // new UnableAddGroupException(Translate.getString("UNABLE_ADD_GROUP_EXCEPTION") + " " + group.getGroupName());
    }    
  }
  ...
  public void registerItem(OpcGroup group, OpcItem item) 
    ...
    try {
      ...
      throw e;//new ComponentNotFoundException(Translate.getString("COMPONENT_NOT_FOUND_EXCEPTION") + " " + item.getItemName());
    }
    catch (UnableAddItemException e) {
      throw e;//new UnableAddItemException(Translate.getString("UNABLE_ADD_ITEM_EXCEPTION") + " " + item.getItemName());
    }
  }
  ...
  public void registerGroups() 
    ...
    try {
      ...
      throw e;//new UnableAddGroupException(Translate.getString("UNABLE_ADD_GROUP_EXCEPTION_UNKNOWN"));    
    }
    catch (UnableAddItemException e) {
      throw e;//new UnableAddItemException(Translate.getString("UNABLE_ADD_ITEM_EXCEPTION_UNKNOWN"));
    }
  }
  ...
  public void unregisterGroup(OpcGroup group) 
    ...
    try {
      ...
      throw e;//new UnableRemoveGroupException(Translate.getString("UNABLE_REMOVE_GROUP_EXCEPTION") + " " + group.getGroupName());
    }
  }
  ...
  public void unregisterItem(OpcGroup group, OpcItem item) 
    ...
    try {
      ...
      throw e;//new UnableRemoveItemException(Translate.getString("UNABLE_REMOVE_ITEM_EXCEPTION") + " " + item.getItemName());
    }
  }
  ...
  public void unregisterGroups() throws UnableRemoveGroupException {
    try {
      ...
      throw e;//new UnableRemoveGroupException(Translate.getString("UNABLE_REMOVE_GROUP_EXCEPTION_UNKNOWN"));
    }
  }
  ...
  public void synchWriteItem(OpcGroup group, OpcItem item) 
    ...
    try {
      ...
      throw e;//new SynchWriteException(Translate.getString("SYNCH_WRITE_EXCEPTION"));
    }
  }
  ...
  public void asynch10Read(OpcGroup group) throws ComponentNotFoundException, Asynch10ReadException {
    try {
      ...
      throw new Asynch10ReadException(("ASYNCH_10_READ_EXCEPTION") + " " +
          group.getGroupName());
    }
  }
  ...
  public void asynch20Read(OpcGroup group) throws ComponentNotFoundException, Asynch20ReadException {
    try {
      ...
      throw new Asynch20ReadException(("ASYNCH_20_READ_EXCEPTION") + " " +
          group.getGroupName());
    }
  }
  ...
  public void asynch10Unadvise(OpcGroup group) throws ComponentNotFoundException, Asynch10UnadviseException {
    try {
      ...
      throw new Asynch10UnadviseException(("ASYNCH_10_UNADVISE_EXCEPTION") + " " +
          group.getGroupName());
    }
  }
  ...
  public void asynch20Unadvise(OpcGroup group) throws ComponentNotFoundException, Asynch20UnadviseException {
    try {
      ...
      throw new Asynch20UnadviseException(("ASYNCH_20_UNADVISE_EXCEPTION") + " " +
          group.getGroupName());
    }
  }
  ...
  public void setGroupUpdateTime(OpcGroup group, int updateTime) throws ComponentNotFoundException, GroupUpdateTimeException {
    try {
      ...
      throw new GroupUpdateTimeException(("GROUP_UPDATETIME_EXCEPTION") + " " +
          group.getGroupName());
    }
  }
  ...
  public void setGroupActivity(OpcGroup group, boolean active) throws ComponentNotFoundException, GroupActivityException {
    try {
      ...
      throw new GroupActivityException(("GROUP_ACTIVITY_EXCEPTION") + " " +
          group.getGroupName());
    }
  }
  ...
  public void setItemActivity(OpcGroup group, OpcItem item, boolean active)
    ...
    try {
      ...
      throw new ItemActivityException(("ITEM_ACTIVITY_EXCEPTION") + " " +
          item.getItemName());
    }
  }
